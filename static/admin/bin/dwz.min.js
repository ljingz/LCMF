		...
		itemDetail: function(){
			...
			function tdHtml(field){
				...
				switch(field.type){
					 ...
					 */
					case 'select':
						html = '<select name="'+field.name+'" class="'+field.fieldClass+'" '+attrFrag+'>';
						html += '<option value=""></option>';
						var json = $.parseJSON(field.json);
						$.each(json, function(value, text){
							if($.isArray(json)){
								value = text;
							}
							html += '<option value="'+value+'" '+(field.defaultVal==value?"selected":"")+'>'+text+'</option>';
						});
						html += '</select>';
						break;
					default:
